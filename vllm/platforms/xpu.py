...
class XPUPlatform(Platform):
    ...
    def check_and_update_config(cls, vllm_config: VllmConfig) -> None:
        ...
        if compilation_config.level == CompilationLevel.PIECEWISE:
            # cuda graph is not support on xpu platform,
            # fallback to DYNAMO_ONCE
            logger.warning(f"cuda graph is not support on XPU platform, "
                           f"fall back to CompilationLevel.DYNAMO_ONCE")
