...
class GPUModelRunner(
    ...
    def _model_forward(
        ...
        **model_kwargs: dict[str, Any],
        ...
        try:
            ...
            pass
        logger.info(
            "[DBG][gpu_model_runner tp_rank=%d] _model_forward: -> model() "
            "input_ids=%s positions=%s embeds=%s im_tensors=%s",
            _rank,
        ...
        try:
            ...
            pass
        logger.info(
            "[DBG][gpu_model_runner tp_rank=%d] _model_forward: <- model() (synced)",
            _rank,
        )
        return out
    ...
    def execute_model(
        ...
        try:
            ...
            _rank = -1
        logger.debug(
            "[DBG][gpu_model_runner tp_rank=%d] execute_model: enter "
            "num_tokens=%d num_reqs=%d intermediate=%s",
            _rank,
        ...
        try:
            ...
            _rank = -1
        logger.debug(
            "[DBG][gpu_model_runner tp_rank=%d] execute_model: return None "
            "(state cached for sample_tokens)",
            _rank,
        )
        return None
    ...
    def sample_tokens(
        ...
        try:
            ...
            _rank = -1
        logger.debug(
            "[DBG][gpu_model_runner tp_rank=%d] sample_tokens: enter "
